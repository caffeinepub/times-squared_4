...
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: string | null, arg5: string): Promise<{
        __kind__: "ok";
        ok: bigint;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.createArticle(arg0, arg1, arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), arg5);
    ...
    async deleteArticle(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async publishArticle(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async unpublishArticle(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
    ...
    async updateArticle(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string | null, arg5: string | null, arg6: string): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.updateArticle(arg0, arg1, arg2, arg3, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), arg6);
                return from_candid_variant_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
